...
if ($result->num_rows > 0) {
    ...
    echo "</table>";
    $result->free_result();
    // Cách 4: sử dụng fetch_array
    echo "<h5>Cách 4: sử dụng fetch_array <br></h5>";
    $result =$conn->query($sql);
    ...
    $result->free_result();
    // Cách 5: sử dụng fetch_object
    echo "<h5>Cách 5: sử dụng fetch_object <br></h5>";
    $result = $conn->query($sql);
    ...
    echo "<h5>Cách 6: sử dụng fetch_row <br></h5>";
    $result = $conn->query($sql);
    while($row = $result->fetch_row()){
        echo "id: ". $row[0] . " - Hoten: ". $row[1] . " Email: ". 
